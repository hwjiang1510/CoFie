...
def trainer(center_point, sdf_tree, sdf_grid_radius, lat_vecs, sdf_data, indices, cube_size, outer_sum, outer_lock, decoder, loss_l1, do_code_regularization, code_reg_lambda, epoch):
    ...
    # center_point[0] is the grid index
    # indices[0] is the instance index
    ...
    # replicate the code for all points
    ...
    print('gt {}, pred {}, distance {}'.format(sdf_gt.mean().item(), pred_sdf.mean().item(), transformed_sample.mean().item()))
...
def main_function(experiment_directory, continue_from, batch_split):
    ...
    logging.info("latent vector size {}".format(lat_vec_size))
